...
document.write('<script src="/static/frame/bootstrap-3.3.7-dist/js/bootstrap.js" type="text/javascript" charset="utf-8"></script>');
document.write('<script src="/static/frame/layui/layui.all.js" type="text/javascript" charset="utf-8"></script>');
document.write('<script src="/static/js/util.js" type="text/javascript" charset="utf-8"></script>');
document.write('<script src="/static/js/base.js" type="text/javascript" charset="utf-8"></script>');